...
#if defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_AES) || defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_ARIA) || \
    defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_DES) || defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_CAMELLIA) || \
    defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_CHACHA20)
/* Used to collapse code that depends on this key types */
#define IS_MBEDTLS_PSA_BUILTIN_KEY_TYPE_CIPHER
#endif

#if defined(IS_MBEDTLS_PSA_BUILTIN_KEY_TYPE_CIPHER)
...
#endif /* IS_MBEDTLS_PSA_BUILTIN_KEY_TYPE_CIPHER */
