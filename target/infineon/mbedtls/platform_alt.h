...
/* Slot ID of the first builtin test key (used slots from #32) */
#define PSA_CRYPTO_IFX_SE_TEST_SLOT_MIN             (32u)

#define PSA_CRYPTO_IFX_SE_AES_SLOT_NUMBER           (PSA_CRYPTO_IFX_SE_TEST_SLOT_MIN + 0u)
#define PSA_CRYPTO_IFX_SE_ECDSA_SLOT_NUMBER         (PSA_CRYPTO_IFX_SE_TEST_SLOT_MIN + 1u)
#define PSA_CRYPTO_IFX_SE_CMAC128_SLOT_NUMBER       (PSA_CRYPTO_IFX_SE_TEST_SLOT_MIN + 2u)
#define PSA_CRYPTO_IFX_SE_CMAC256_SLOT_NUMBER       (PSA_CRYPTO_IFX_SE_TEST_SLOT_MIN + 3u)
#define PSA_CRYPTO_IFX_SE_ECC384_SLOT_NUMBER        (PSA_CRYPTO_IFX_SE_TEST_SLOT_MIN + 4u)
#define PSA_CRYPTO_IFX_SE_CMACKDF_SLOT_NUMBER       (PSA_CRYPTO_IFX_SE_TEST_SLOT_MIN + 5u)
